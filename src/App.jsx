        ...
        <div className="section">
          ...
          <div className="about-grid">
            ...
            <div>
              ...
              <p className="about-text">
                Rather than pursue a master's right away, I moved into industry. I spent nearly seven years as an <span style={{color:"var(--acc)"}}>Instrumentation &amp; Controls Engineer at KRIBHCO Fertilizers Ltd</span>, one of India's largest fertilizer producers. I designed and tuned closed-loop control on Honeywell Experion DCS and Siemens PLC systems, built advanced control strategies that reduced equipment downtime by up to 50%, and owned the full automation lifecycle for safety-critical process units.
              </p>
              <p className="about-text">
              ...
              <div className="timeline">
                {[
                  ...
                  {year:"Oct 2018 – Jul 2025", role:"Instrumentation & Controls Engineer", org:"KRIBHCO Fertilizers Ltd · Gujarat, India", desc:"Designed and tuned closed-loop control on Honeywell Experion DCS and Siemens PLCs. Built advanced control strategies reducing equipment downtime by up to 50% and false trips by 90%. Owned full automation lifecycle for safety-critical units.", active:false},
